...
Create an empty scratch file, then read your to-do list:
  touch ~/playground/scratch.txt
  cat ~/playground/notes/todo.txt"
TASK_TRY="touch ~/playground/scratch.txt"
